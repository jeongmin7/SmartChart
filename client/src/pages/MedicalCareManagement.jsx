          ...
          <TopSection>
            ...
            <Content>
              <TextArea
                name="medicalHistory"
                onChange={onChange}
                defaultValue={receivedNote[0]?.medicalHistory || ""}
              />
            </Content>
          </TopSection>
          <TopSection>
            ...
            <Content>
              <TextArea
                name="mainSymptoms"
                onChange={onChange}
                defaultValue={receivedNote[0]?.mainSymptoms || ""}
              />
            </Content>
          </TopSection>
          <TopSection>
            ...
            <Content>
              <TextArea
                ...
                onChange={onChange}
                defaultValue={receivedNote[0]?.currentSymptoms || ""}
              />
            </Content>
          </TopSection>
          <TopSection>
            ...
            <Content>
              <TextArea
                name="treatmentPlan"
                onChange={onChange}
                defaultValue={receivedNote[0]?.treatmentPlan || ""}
              />
            </Content>
          </TopSection>
        </TopContainer>
        <BottomContainer>
          ...
          <Content>
            <TextArea
              name="note"
              onChange={onChange}
              defaultValue={receivedNote[0]?.note || ""}
            />
          </Content>
        </BottomContainer>
      </BigContainer>
